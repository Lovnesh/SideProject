...
public class GUI extends JFrame {
    ...
    private static final Color[] colour = {
        Color.WHITE, //Whils the cell is alive
        Color.BLACK, //Cell is dead.
    };
    ...
    public GUI(GameOfLife game, int rows, int columns) {
    ...
    public void showCells() {
        ...
        for(int i = 0; i < columnLength; i++) {
            for(int j = 0; j < rowLength; j++) {
                ...
                view.drawMark(j, i, colour[cellColour]);
            }
        }
    ...
    private class Runner extends SwingWorker<Boolean, Void> {
        @Override
        /**
         * Iteretively steps through the environment whilst the animation is running
         */
